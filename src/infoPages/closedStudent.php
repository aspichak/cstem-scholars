...
<link rel="stylesheet" href="closedStudent.css">
<body>
...
<div class="w3-content w3-container w3-padding-32" id="about">
  <h3 class="w3-center">The CSTEM Research Grant application has been closed. Please check back at a later date.</h3>
  <p></p>
 </div>
