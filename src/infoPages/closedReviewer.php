...
<link rel="stylesheet" href="closedReviewer.css">
<?php
...
<div class="w3-content w3-container w3-padding-32" id="about">
  <h3 class="w3-center">The grant application is still open to students. Check back after <?php echo $date?> for new applications to review.</h3>
  <p></p>
 </div>
