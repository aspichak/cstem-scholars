...
$hasStudent = $_SESSION['hasStudent'];
...
if($update)
{
  ...
  $query = $pdo->prepare("UPDATE `$tableName` SET PTitle='$pTitle', Objective='$objective', Timeline='$timeline', Budget=$budget, RequestedBudget=$requestedBudget, FundingSources='$fundingSources',AnticipatedResults='$anticipatedResults', Justification='$justification', BudgetFilePath='$filePath', Submitted='1', AdvisorApproved='0' WHERE SID=$sid");
  $query->execute();
