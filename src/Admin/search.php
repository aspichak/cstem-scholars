...
<head>
    ...
    foreach ($result as $value) {
        $result[$count] = "SELECT *, '$value[0]'as 'tablename' FROM " . $value[0] . " where Submitted =1";
        $count++;
    }
    $queryStatement;
    foreach ($result as $value) {
...
<form method="post">
    ...
    <div class="main">
        <div class="w3-container">
            ...
            <button type='submit' formaction='searchsorted.php'
            = >Go</button>
        </div>
        <div class="w3-container">
            <br>
            <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
                ...
                foreach ($sth->fetchAll(PDO::FETCH_ASSOC) as $row) {
                    ...
                    <tr>
                        ...
                        <td>
                            <button type='submit'
                                    formaction="view.php?id=<?php echo $row['ApplicationNum']; ?>&table=<?php echo $row['tablename'] ?>">
                                View
                            </button>
                    </tr>
                <?php } ?>
