...
<form method = "post">
	...
	<div class="main">
		<div class="w3-container">
			...
			<option selected value="Score">Score</option>
			...
			<?php $app = $row['ApplicationNum'];?>
				...
				<input type="hidden" name="app" id = "app" value="<?php echo $row['ApplicationNum']; ?>"/>
				...
				<td><button type = "submit" formaction= "award.php?id=<?php echo $row[ApplicationNum]?>">Select</button>
				</tr>
			<?php endforeach;?>
			</table><br>
