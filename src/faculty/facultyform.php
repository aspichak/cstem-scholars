...
<div class="form">
    ...
    <form method="post" action="formsubmit.php?id=<?php echo $id ?>">
        ...
        <div class="inner-section">
            ...
            <input type="radio" name="group" id="Not Approved" value="Not Approved" onclick="enable()">Student does not
            meet grant requirements<br>
            <input type="radio" name="group" id="Update" value="Update" onclick="enable()">Student needs to make changes
